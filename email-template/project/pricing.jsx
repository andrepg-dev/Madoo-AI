...
const PRICING_PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Remove "Sent with Mailmint" footer', included: false },
    ],
  ...
  },
  {
    ...
    priceAnnual: 63,
    contacts: '15,000',
    sends: '100,000 emails/mo',
    features: [
      { label: 'Unlimited AI generations', included: true },
      { label: 'Premium template gallery', included: true },
      { label: 'Multi-domain sending', included: true },
      { label: 'Advanced analytics & cohorts', included: true },
      { label: 'A/B test everything (subject, body, send time)', included: true },
      { label: 'Drip campaigns & automations', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'SOC 2 + GDPR DPA', included: true },
      { label: 'Dedicated success manager', included: true },
      { label: '99.9% SLA + onboarding', included: true },
    ],
    cta: 'Talk to sales',
    highlight: false,
  },
