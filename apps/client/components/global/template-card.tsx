...
export default function TemplateCard({
  ...
  return (
    <button
      ...
      type="button"
    >
      <div className="relative flex aspect-4/5 min-h-52 items-center justify-center overflow-hidden rounded-lg bg-white shadow-[inset_0_0_0_0.5px_rgb(12_52_106/0.16)] transition-[box-shadow] duration-150 group-focus-visible:shadow-[inset_0_0_0_1.5px_var(--accent)]">
        {previewUrl ? (
          <img
            alt=""
