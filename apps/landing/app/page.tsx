  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#f8fafb]">
      ...
      <img
        ...
        className="pointer-events-none absolute inset-0 z-0 h-screen w-full opacity-20"
        alt=""
        aria-hidden="true"
      />
      ...
      <div className="relative z-50 flex h-screen w-full flex-col items-center justify-center gap-9">
        ...
        <div className="min-w-[700px] rounded-3xl bg-white shadow-[inset_0_0_0_0.5px_#b8d2e4]">
          <textarea
            placeholder="Ask Madoo to build a email template campaign based on my page example.com"
            className="min-h-24 w-full resize-none rounded-t-3xl bg-transparent px-5 pt-5 text-sm text-[#101114] outline-none placeholder:text-zinc-600"
          />
          ...
          <div className="flex items-center justify-between px-3.5 pb-3">
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                className="inline-flex cursor-pointer items-center gap-1 rounded-full px-2.5 py-1.5 text-xs text-[#101114] transition hover:bg-[#f3faff]"
              >
                Build
                <HugeiconsIcon
                  icon={ArrowDown01Icon}
              ...
              <button
                type="button"
                className="inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-[#7d7d7a] text-white transition hover:bg-[#666663]"
