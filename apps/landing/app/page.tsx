...
const providerLogoSwatches = ["#f2e8ff", "#e7f0ff", "#e8fbff", "#f7ecff", "#eaf8ef", "#fff0e6"];
...
const localeCopy = {
  en: {
    ...
    workflow: {
      ...
      steps: [
        { label: "Prompt", text: "Describe the audience, offer, tone, and goal." },
        { label: "Design", text: "Madoo turns it into a polished email layout." },
    ...
    templates: {
      ...
      cards: [
        { name: "Create your own", description: "Start with a blank email template." },
        { name: "Big news: We've been backed by Y Combinator 🚀", description: "Bold startup funding announcement." },
        { name: "Tu próximo hogar está a un clic — Hopta", description: "Clean real estate offer in Spanish." },
        { name: "40% off everything — no exceptions", description: "High-contrast Black Friday promo." },
        { name: "Beautiful emails, built in seconds — Madoo AI", description: "Editorial product update layout." },
        {
          name: "We're officially backed by Y Combinator — here's what's next",
          description: "Investor-backed milestone note.",
        },
        { name: "We just shipped something big 🚀", description: "Dark invite-style product launch." },
        { name: "Big ideas. Short sentences. Zero fluff.", description: "Minimal long-form newsletter." },
      ],
    },
    cta: {
  ...
  es: {
    ...
    hero: {
      top: "Inteligencia Artificial",
      highlight: "para Emails",
      subtitle: "Diseña tu plantilla de email con IA y avanza más rápido",
      placeholder:
    ...
    workflow: {
      ...
      steps: [
        { label: "Prompt", text: "Describe audiencia, oferta, tono y objetivo." },
    ...
    templates: {
      ...
      hover: "Detalles",
      cards: [
        { name: "Crea la tuya", description: "Empieza con una plantilla en blanco." },
        ...
        { name: "Acabamos de lanzar algo grande 🚀", description: "Lanzamiento oscuro estilo invitación." },
        { name: "Ideas grandes. Frases cortas. Cero ruido.", description: "Newsletter minimalista de largo formato." },
      ],
    },
    cta: {
...
export default function HomePage({ locale = "en" }: { locale?: Locale } = {}) {
  ...
  useEffect(() => {
    [promptTextareaRef.current, ctaPromptTextareaRef.current].forEach((textarea) => {
      if (!textarea) return;
  ...
  return (
    <>
      ...
      <main lang={locale} className="relative min-h-screen w-full bg-[#fbfaf6]">
        <div className="madoo-paper-background pointer-events-none absolute inset-0 z-0" aria-hidden="true" />


        <header className="sticky top-0 left-0 right-0 z-[100] pointer-events-auto border-b border-black/5 bg-[#fbfaf6]/82 backdrop-blur-md">
          <div className="flex h-16 items-center justify-between px-4 sm:px-8 xl:px-48">
            <div className="flex gap-16">
              ...
              >
                ...
                <a className="cursor-pointer" href="#community">{copy.nav.community}</a>
                <a className="cursor-pointer" href="/pricing">{copy.nav.pricing}</a>
              </nav>
            </div>
        ...
        <div className="madoo-paper-section madoo-paper-hero relative z-50 flex h-screen w-full flex-col items-center justify-center gap-9 font-ibm-plex-sans">
          <div className="flex flex-col gap-1.5">
            <h3 className="text-center text-5xl font-medium leading-[0.94] tracking-normal text-[#071b38]">
              <span className="block text-zinc-700">{copy.hero.top}</span>
        ...
        <section className="madoo-paper-section relative z-10 w-full pb-32 pt-0">
          <div className="madoo-paper-border mx-auto grid w-full max-w-7xl gap-10 font-ibm-plex-sans text-[#171717] sm:py-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                ...
                <div key={column.title}>
                  ...
                  <ul className="space-y-3.5">
                    {column.links.map((link) => (
                      <li key={link}>
                        <a className="text-sm text-[#24221f] transition hover:text-[#5b63ff]" href="#">
                          {link}
                        </a>
                      </li>
                    ))}
